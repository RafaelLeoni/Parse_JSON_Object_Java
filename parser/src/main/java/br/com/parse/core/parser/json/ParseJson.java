...
public class ParseJson {
	...
	public String toJson(Object object) throws ParseException {		
		if(ReflectionUtil.isCollection(object.getClass().getGenericSuperclass())){
			return toNodeAsCollection((Collection<?>) object);
		}else{
			return toNodeAsObject(object);
		}
	}

	private String toNodeAsObject(Object object) {
	...
	private String toNodeAsCollection(Collection<?> collection) {
